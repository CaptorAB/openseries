...
To easily use all of the tools available in the Pandas library an attribute `tsdf` is added upon `__init__` of the [OpenTimeSeries](https://github.com/CaptorAB/OpenSeries/blob/master/series.py) and [OpenFrame](https://github.com/CaptorAB/OpenSeries/blob/master/frame.py) classes.

#### These are the files / modules described.

| Module | Description |
| :--- | :--- |
| [OpenTimeSeries, defined in series.py](https://github.com/CaptorAB/OpenSeries/blob/master/series.py) | The *Class* for managing and analyzing a single timeseries. The module also defines a function `timeseries_chain` that can be used to chain two timeseries objects together. |
| [OpenFrame, defined in frame.py](https://github.com/CaptorAB/OpenSeries/blob/master/frame.py) | The *Class* for managing a group of timeseries, and e.g. calculate a portfolio timeseries from a rebalancing strategy between timeseries. |
| [main.py](https://github.com/CaptorAB/OpenSeries/blob/master/main.py) | A module with usage examples. |
| [CaptorOpenApiService, defined in captor_open_api_sdk.py](https://github.com/CaptorAB/OpenSeries/blob/master/captor_open_api_sdk.py) | A Python SDK to interact with the Captor Open API. |
| [datefixer.py](https://github.com/CaptorAB/OpenSeries/blob/master/datefixer.py) | A module with date utilities. |
| [helpfilewriter.py](https://github.com/CaptorAB/OpenSeries/blob/master/helpfilewriter.py) | A module that allows printing a description of a Python class. |
| [openseries.json](https://github.com/CaptorAB/OpenSeries/blob/master/openseries.json) | The jsonschema of the OpenTimeSeries class. |
| [plotly_layouts.json](https://github.com/CaptorAB/OpenSeries/blob/master/plotly_layouts.json) | A module setting Plotly defaults used in the plot_series methods. |
| [risk.py](https://github.com/CaptorAB/OpenSeries/blob/master/risk.py) | Module with methods used to calculate VaR, CVaR and drawdowns. |
| [sim_price.py](https://github.com/CaptorAB/OpenSeries/blob/master/sim_price.py) | Module to simulate OpenTimeSeries from different stochastic processes. |
| [stoch_processes.py](https://github.com/CaptorAB/OpenSeries/blob/master/stoch_processes.py) | Module to generate stochastic processes used in the `sim_price.py` module. |
| [sweden_holidays.py](https://github.com/CaptorAB/OpenSeries/blob/master/sweden_holidays.py) | Module that defines a Swedish business calendar. |

#### Below are the class methods used to create an OpenTimeSeries object.
...
| `validate_vs_schema` | `OpenTimeSeries` | Method to validate the OpenTimeSeries input against the [openseries.json](https://github.com/CaptorAB/OpenSeries/blob/master/openseries.json) jsonschema. |
| `to_json` | `OpenTimeSeries` | Method to export the OpenTimeSeries \__dict\__ to a json file. |
...
| `plot_series` | `OpenTimeSeries`, `OpenFrame` | Opens an HTML Plotly plot of the series in a browser window. |
