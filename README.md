...
To easily use all of the tools available in the [Pandas](https://pandas.pydata.org/) library an attribute `tsdf` is added upon `__init__` of the [OpenTimeSeries](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/series.py) and [OpenFrame](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/frame.py) classes.

#### These are the files / modules described.

| Module | Description |
| :--- | :--- |
| [OpenTimeSeries, defined in series.py](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/series.py) | The *Class* for managing and analyzing a single timeseries. The module also defines a function `timeseries_chain` that can be used to chain two timeseries objects together. |
| [OpenFrame, defined in frame.py](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/frame.py) | The *Class* for managing a group of timeseries, and e.g. calculate a portfolio timeseries from a rebalancing strategy between timeseries. |
| [main.py](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/main.py) | A module with usage examples. |
| [CaptorOpenApiService, defined in captor_open_api_sdk.py](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/captor_open_api_sdk.py) | A Python SDK to interact with the Captor Open API. |
| [datefixer.py](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/datefixer.py) | A module with date utilities. |
| [helpfilewriter.py](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/helpfilewriter.py) | A module that allows printing a description of a Python class. |
| [openseries.json](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/openseries.json) | The jsonschema of the OpenTimeSeries class. |
| [plotly_layouts.json](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/plotly_layouts.json) | A module setting [Plotly](https://plotly.com/python/) defaults used in the `plot_series` methods. |
| [risk.py](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/risk.py) | Module with methods used to calculate VaR, CVaR and drawdowns. |
| [sim_price.py](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/sim_price.py) | Module to simulate OpenTimeSeries from different stochastic processes. |
| [stoch_processes.py](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/stoch_processes.py) | Module to generate stochastic processes used in the `sim_price.py` module. |
| [sweden_holidays.py](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/sweden_holidays.py) | Module that defines a Swedish business calendar. |

#### Below are the class methods used to create an [OpenTimeSeries](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/series.py) object.
...
#### In this table are the non-numeric or "helper" properties that apply only to the [OpenTimeSeries](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/series.py) class. 
...
#### In this table are the non-numeric or "helper" properties that apply only to the [OpenFrame](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/frame.py) class.
...
#### In this table are the non-numeric or "helper" properties that apply to both the [OpenTimeSeries](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/series.py) and the [OpenFrame](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/frame.py) class.
...
#### In this table are the methods that apply only to the [OpenTimeSeries](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/series.py) class.

| Method | Applies to | Description |
| :--- | :--- | :--- |
| `setup_class` | `OpenTimeSeries` | Class method that defines the `domestic` attribute and a `sweden` business day calendar. |
| `validate_vs_schema` | `OpenTimeSeries` | Method to validate the OpenTimeSeries input against the [openseries.json](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/openseries.json) jsonschema. |
...
#### In this table are the methods that apply only to the [OpenFrame](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/frame.py) class.
...
#### In this table are the methods that apply to both the [OpenTimeSeries](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/series.py) and the [OpenFrame](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/frame.py) class.
...
#### Below are the numeric properties available for individual [OpenTimeSeries](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/series.py) or on all series in an [OpenFrame](https://github.com/CaptorAB/Python/blob/master/Apps/OpenSeries/frame.py).
