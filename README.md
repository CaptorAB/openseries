...
| [_common_model.py](https://github.com/CaptorAB/OpenSeries/blob/master/openseries/_common_model.py)               | Defines the class _CommonModel_ which is a base class for both the above classes.                                                                                                                   |
...
| [_risk.py](https://github.com/CaptorAB/OpenSeries/blob/master/openseries/_risk.py)                               | Functions used to calculate VaR, CVaR and drawdowns.                                                                                                                                                |
