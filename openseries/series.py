...
class OpenTimeSeries(object):
    ...
    def __repr__(self):
        ...
        return (
            "{}(label={}, _id={}, valuetype={}, currency={}, start={}, end={})".format(
    ...
    def rolling_var_down(
        self, level: float = 0.95, observations: int = 252, interpolation: str = "lower"
    ) -> pd.DataFrame:
        """
    ...
    def set_new_label(
        self, lvl_zero: str = None, lvl_one: str = None, delete_lvl_one: bool = False
    ):
        """
